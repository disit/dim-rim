...
class sm_Pager{
	 ...
	 *
	 * @param numeric  $_perLing  sets the link for browsing the page
	...
	/**
	 * Set the limit to aplly when paging
	 * @param unknown $data
	 */
	...
	/**
	 * Check if the result number is changed to reset the current paging
	 * @param unknown $data
	 * @return boolean
	 */
	...
	/**
	 * Set the page Link to use for browsing page
	 * @param unknown $pageLink
	 */
	...
	/**
	 * Get the page Link used for browsing page 
	...
	/**
	 * Get the current page Link used for browsing page (page currently focussed)
	 * @return Ambigous <unknown, string>
	 */
	...
	/**
	 * Array of options per page view

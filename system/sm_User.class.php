...
class sm_User implements sm_Module {
  ...
  function __construct() 
  {
	  ...
	  /*  if( !isset( $_SESSION ) ) 
	    ...
	    if ( !empty($_SESSION[$this->sessionVariable]) )
	    {
		   ...
		   if($this->loadUser( $_SESSION[$this->sessionVariable] ))
		   {
  ...
  public function login($uname, $password, $remember = false, $loadUser = true)
  {
		...
		*/
		...
		//	session_start();
			...
			if ( $remember ){
			  $cookie = base64_encode(serialize(array('uname'=>$uname,'password'=>$originalPassword)));
			  $_SESSION[$this->remCookieName]=$cookie;
  ...
  */
  public function logout($redirectTo = '')
  {
    ...
    {
    	if(isset($_SESSION[$this->remCookieName]))
    			setcookie($this->remCookieName,null,time()-$this->remTime, '/');//, $this->remCookieDomain);
    	unset($_SESSION);
    	session_destroy();
 ...
 /**
  	* @desc Function to determine if a property is true or false
  	* @param string $prop
  	* @return bool
  */
  protected function is($prop){
    ...
    /**
  	* @desc Get a property of a user. You should give here the name of the field that you seek from the user table
  ...
  */
  ...
  /**
  	* @desc Is the user an active user?
  	* @return bool
  */
  function is_active()
  {
  ...
  /**
  	* @desc Activates the user account
  	* @return bool
  */
  function activate()
  {
  ...
  /**
   * @descCreates a user account. The array should have the form 'database field' => 'value'
   * @param array $data
   * @return int
   */  
  ...
  */
  ...
  /**
   * @desc Creates a random password. You can use it to create a password or a hash for user activation
   * @param int $length
   * @param string $chrs
   * @return string
   */
  ...
  */
  ...
  /**
  	* @desc A function that is used to load one user's data
  	* @access private
  	* @param string $userID
  	* @return bool
  */
  ...
  /**
  	* @desc Produces the result of addslashes() with more safety
  	* @access private
  	* @param string $str
  	* @return string
  */  
  ...
  /**
  	* @desc Error holder for the class
  	* @access private
  	* @param string $error
  	* @param int $line
  	* @param bool $die
  ...
  */  
  ...
  /**
  * @desc Check user account data. The array should have the form 'database field' => 'value'
  * @param array $data
  * @return bool
  */
 ...
 static public function install($db)
 {
	...
	$sql_admin ="INSERT INTO `".USERTABLENAME."` (`id`,`username`, `password`, `email`, `active`) VALUES

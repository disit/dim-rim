...
include '../apps/siimob/SiiMobility_InitApiServer.php';
...
$server = new APIRest_Server($mode);
$server->refreshCache(); // uncomment momentarily to clear the cache if classes change in production mode
$server->addControllerClass('SiiMobility_RestServerController');
$server->addControllerClass('SiiMobility_IndexManagerRestController');
$server->addControllerClass('OWLIM_RestController');
$server->addControllerClass('GraphDB_RestController');
$server->handle();
//$server->exportMap();
